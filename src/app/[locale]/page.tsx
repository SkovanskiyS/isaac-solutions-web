...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section id="home" className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden scroll-mt-20 gradient-corporate">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center">
            ...
            <FadeIn delay={0.4}>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mx-auto max-w-md">
                ...
                <a href="#portfolio" className="w-full sm:w-auto">
                  <Button variant="outline" size="xl" className="flex-shrink-0 w-full sm:w-auto group glass border-blue-500/30 hover:bg-blue-500/10 shadow-corporate hover:shadow-corporate-lg">
            ...
            <StaggerContainer staggerDelay={0.15} className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <StaggerItem>
      ...
      {/* Services Section */}
      <section id="services" className="py-24 px-4 sm:px-6 lg:px-8 scroll-mt-20 relative">
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <ScrollReveal delay={0.1}>
              <Card className="card-elevated h-full border-2 hover:border-blue-500/50 shadow-corporate-lg">
                <CardHeader>
                  ...
                  <CardTitle className="text-foreground text-2xl">{t('services.webDev.title')}</CardTitle>
            ...
            <ScrollReveal delay={0.2}>
              <Card className="card-elevated h-full border-2 hover:border-green-500/50 shadow-corporate-lg">
                <CardHeader>
                  ...
                  <CardTitle className="text-foreground text-2xl">{t('services.mobileDev.title')}</CardTitle>
                  <CardDescription className="text-base">
            ...
            <ScrollReveal delay={0.3}>
              <Card className="card-elevated h-full border-2 hover:border-purple-500/50 shadow-corporate-lg">
                <CardHeader>
                  ...
                  <CardTitle className="text-foreground text-2xl">{t('services.uxUiDesign.title')}</CardTitle>
                  <CardDescription className="text-base">
          ...
          <ScrollReveal delay={0.4} className="mt-16 text-center">
            <div className="inline-flex items-center px-8 py-4 glass-strong rounded-full border-2 border-blue-500/30 hover:scale-105 transition-transform duration-300 shadow-corporate-lg">
              ...
              <span className="text-foreground font-semibold text-lg">{t('services.aiAdvantage.label')}</span>
      ...
      {/* About Section */}
      <section id="about" className="py-24 px-4 sm:px-6 lg:px-8 scroll-mt-20 relative">
        {/* Background decoration */}
        <div className="absolute inset-0 gradient-corporate -z-10"></div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <Card className="card-elevated p-8 text-center flex flex-col h-full border-2 border-blue-500/20">
              ...
              <p className="text-blue-500 font-semibold mb-4 text-lg">{t('about.team.javohir.position')}</p>
              <div className="text-muted-foreground space-y-3 text-left flex-grow">
                <p className="leading-relaxed">
                  {t('about.team.javohir.bio')}
                </p>
                <div className="pt-4">
                  <h4 className="font-semibold text-foreground mb-3">{t('about.team.javohir.expertise')}</h4>
                  <div className="flex flex-wrap gap-2">
                    {(t.raw('about.team.javohir.skills') as string[]).map((skill: string, index: number) => (
                      <Badge key={index} variant="outline" className="glass border-blue-500/30">{skill}</Badge>
                    ))}
                  </div>
                </div>
              </div>
            ...
            <Card className="card-elevated p-8 text-center flex flex-col h-full border-2 border-green-500/20">
              ...
              <p className="text-green-500 font-semibold mb-4 text-lg">{t('about.team.jahongir.position')}</p>
              <div className="text-muted-foreground space-y-3 text-left flex-grow">
                <p className="leading-relaxed">
                  {t('about.team.jahongir.bio')}
                </p>
                <div className="pt-4">
                  <h4 className="font-semibold text-foreground mb-3">{t('about.team.jahongir.expertise')}</h4>
                  <div className="flex flex-wrap gap-2">
                    {(t.raw('about.team.jahongir.skills') as string[]).map((skill: string, index: number) => (
                      <Badge key={index} variant="outline" className="glass border-green-500/30">{skill}</Badge>
                    ))}
                  </div>
                </div>
              </div>
            ...
            <Card className="card-elevated p-8 text-center flex flex-col h-full border-2 border-orange-500/20">
              ...
              <p className="text-orange-500 font-semibold mb-4 text-lg">{t('about.team.alex.position')}</p>
              <div className="text-muted-foreground space-y-3 text-left flex-grow">
                <p className="leading-relaxed">
                  {t('about.team.alex.bio')}
                </p>
                <div className="pt-4">
                  <h4 className="font-semibold text-foreground mb-3">{t('about.team.alex.expertise')}</h4>
                  <div className="flex flex-wrap gap-2">
                    {(t.raw('about.team.alex.skills') as string[]).map((skill: string, index: number) => (
                      <Badge key={index} variant="outline" className="glass border-orange-500/30">{skill}</Badge>
                    ))}
                  </div>
                </div>
              </div>
          ...
          <ScrollReveal delay={0.4} className="mt-20 text-center">
            <div className="max-w-3xl mx-auto glass-strong p-8 rounded-2xl border-2 border-blue-500/30 shadow-corporate-xl">
              <h3 className="text-3xl font-bold text-foreground mb-4">{t('about.vision.title')}</h3>
