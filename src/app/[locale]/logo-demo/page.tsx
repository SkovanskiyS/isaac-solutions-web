    ...
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-sm text-muted-foreground mb-12">
          Clean, formal designs suitable for business contexts, documents, and
          digital presence.
        </p>
        ...
        <div className="mt-16 border-t border-border pt-12">
          ...
          <div className="bg-slate-50 dark:bg-slate-900/50 rounded-xl p-8 border border-slate-200 dark:border-slate-800">
            ...
            <ul className="space-y-3 text-muted-foreground">
              <li>
                <strong className="text-foreground">Primary:</strong> Main
                website navigation, hero sections, general branding
              </li>
              <li>
                <strong className="text-foreground">Corporate:</strong> Business
                cards, formal documents, enterprise presentations
              </li>
              <li>
                <strong className="text-foreground">Elegant:</strong> Marketing
                materials, proposals, premium contexts
              </li>
              <li>
                <strong className="text-foreground">Geometric:</strong>{" "}
                Tech-focused content, developer documentation
              </li>
              <li>
                <strong className="text-foreground">Wordmark:</strong> Favicons,
                app icons, watermarks, small applications
              </li>
            </ul>
          </div>
        </div>
