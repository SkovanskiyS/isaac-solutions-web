  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ghost: "hover:bg-blue-500/10 hover:text-blue-400 transition-all duration-300 active:scale-95",
        link: "text-blue-400 underline-offset-4 hover:underline hover:text-blue-300 active:scale-95",
        premium: "bg-gradient-to-r from-amber-500 to-orange-600 text-white shadow-xl hover:shadow-2xl hover:from-amber-600 hover:to-orange-700 transform hover:scale-105 ring-2 ring-amber-500/20 active:scale-95 active:shadow-lg",
        trading: "bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-lg hover:shadow-xl hover:from-green-700 hover:to-emerald-700 transform hover:scale-105 active:scale-95 active:shadow-md",
        danger: "bg-gradient-to-r from-red-600 to-pink-600 text-white shadow-lg hover:shadow-xl hover:from-red-700 hover:to-pink-700 transform hover:scale-105 active:scale-95 active:shadow-md",
      },
      size: {
